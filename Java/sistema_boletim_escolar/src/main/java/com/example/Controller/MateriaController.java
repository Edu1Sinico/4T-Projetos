...
public class MateriaController {
    ...
    private void atualizarTabela(){
        ...
        for (Materia materia : materias) {
            ...
            tableModel.addRow(new Object[] { materia.getId(), materia.getNomeMateria(),
                    materia.getNota1(), materia.getNota2(), materia.getNota3(), materia.getMedia(), materia.getRaAluno()});
        }
    }
    ...
    public void cadastrar(int id, String nomeMateria, double nota1, double nota2, double nota3, double media, String raAluno, String cpfProfessor) {
